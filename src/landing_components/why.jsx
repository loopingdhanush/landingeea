...
export default function Why() {
    ...
    <section>
            ...
            <p className="text-lg text-gray-900 dark:text-orange-100 text-center max-w-3xl mx-auto mt-8 mb-16">
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 my-16 md:gap-x-8'>
            <div className="flex flex-col justify-center text-left mb-6 md:mb-0 ">
                ...
                <p className="text-gray-900 dark:text-orange-100 mb-6 max-w-md">
                    Live Interactive online classes for Classes 10–12, NEET & JEE. All sessions are recorded for easy revision</p>
            </div>
            <img src={v1} alt="Live Classes" className="w-full h-auto rounded-lg shadow-xl mb-6 md:mb-0" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 my-16 lg:gap-x-8 ">
            <div className="order-1 md:order-2 flex flex-col justify-center text-right mb-6 md:mb-0 ">
                ...
                <p className="text-gray-900 dark:text-orange-100 mb-6 ml-8">An online platform for MCQ practice, performance tracking, and class scheduling, everything in one place.</p>
            </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 md:gap-x-8'>
            <div className="flex flex-col justify-center text-left mb-6 md:mb-0">
                ...
                <p className="text-gray-900 dark:text-orange-100 mb-6 max-w-md">Access PDF notes, solved examples, revision sheets, and videos. all aligned with the latest syllabus and exams.</p>
            </div>
            <img src={v3} alt="Live Classes" className="w-full h-auto rounded-lg shadow-xl mb-6 md:mb-0" />
        </div>
