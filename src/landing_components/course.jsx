...
export default function Course(){
    ...
    <section>
        ...
        <p className="text-lg text-gray-900 dark:text-orange-100 text-center max-w-3xl mx-auto mt-8 mb-8 futura-font">
            Our courses are designed to help students excel in their academic pursuits. From <strong>board exams to competitive entrance tests,</strong> our courses are tailored to meet the diverse needs of students</p>
